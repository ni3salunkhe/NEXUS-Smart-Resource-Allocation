...
async def ensure_topics_exist(max_retries: int = 5, base_delay: float = 2.0):
    """Create all Kafka topics if they don't exist. Retries on coordinator errors."""
        ...
        try:
            ...
            try:
                ...
                if to_create:
                    ...
                    logger.info(f"All {len(existing)} Kafka topics already exist")
                return  # Success
            finally:
                await admin.close()
        except Exception as e:
